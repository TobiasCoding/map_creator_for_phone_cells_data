        ...
        while True:
            ...
            if respuesta == '2':
                while True:
                    ...
                    if timestamp_inicio == timestamp_final: print("\nERROR, la fecha y hora de interes 'DESDE' es idéntica a la fecha y hora 'HASTA'"); continue
                    import datetime
